...
SpectraStatusChip::SpectraStatusChip(const QString& text, Type type,
                                     QWidget* parent)
...
void SpectraStatusChip::paintEvent(QPaintEvent*)
{
    ...
    {
    case Type::Accent:
        bg_color = QColor(c.cyan_accent.red(), c.cyan_accent.green(),
                          c.cyan_accent.blue(), 30);
        text_color = c.cyan_accent;
        break;
    case Type::Success:
        bg_color = QColor(c.success_green.red(), c.success_green.green(),
                          c.success_green.blue(), 30);
        text_color = c.success_green;
        break;
    case Type::Warning:
        bg_color = QColor(c.warning_amber.red(), c.warning_amber.green(),
                          c.warning_amber.blue(), 30);
        text_color = c.warning_amber;
        break;
    default:
        bg_color = QColor(c.elevated_surface.red(), c.elevated_surface.green(),
